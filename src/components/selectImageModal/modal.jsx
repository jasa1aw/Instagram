...
export default function Modal({ closeModal }) {
    ...
    return (
        ...
        {step == 1 && <div className="modalContainer">
            <div className="title">
        ...
        {step == 2 && <div className="modalContainer uploadPost">
            <div className="title title2">
                <button onClick={() => {setStep(1)}}  className="button back-btn">
                    <img className="img" src="/img/icons/arrowLeft.svg" alt="" />
                </button>
                <h2>Create new post</h2>
                <button onClick={() => {closeModal(false);}} className="button share-btn">Share</button>
            </div>
            <div className="block">
                ...
                <div className="block-item-user">
                    ...
                    <textarea className="textarea" cols="40" rows="13" placeholder="Write a caption..."></textarea>
                    <div className="emoji">
